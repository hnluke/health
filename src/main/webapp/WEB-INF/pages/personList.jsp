...
<body>
<form id="submitForm" name="submitForm" action="check/persons/2" method="post">
                        ...
                        <c:if test="${!empty(perList)}">
                            <c:forEach var="per"  items="${perList}">
                                <tr>
                                    ...
                                    <td>${per.cardId}</td>
                                    <td>${per.cardNo}</td>
                                    <td>${per.person.perName}</td>
                                    <td>${per.person.perAge}</td>
                                    <td><a href="check/persons/3?cardId=${per.cardNo}" target="_blank">详细信息</a></td>
                                </tr>
                            </c:forEach>
                        </c:if>
                    </table>
