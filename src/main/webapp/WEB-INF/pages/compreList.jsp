...
<body>
<form id="submitForm" name="submitForm" action="check/compre/2" method="post">
            ...
            <div id = "guide" style="width: 100%; float:left; overflow: scroll; height: 500px" >
                <form id="assoForm">
                    <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                        ...
                        <c:if test="${!empty(compresList)}">
                            <c:forEach var="compre"  items="${compresList}">
                                <tr>

                                    <td>${compre.batchId}</td>
                                    <td>${compre.person.cards.cardNo}</td>
                                    <td>${compre.batchNo}</td>
                                    <td>${compre.person.perName}</td>
                                    <td>${compre.batchPay}</td>
                                    <td>${compre.batchCmp}</td>
                                    <td><a href="check/report/3?batchNo=${compre.batchNo}" target="_blank">体检报告</a></td>
                                    <td><a href="check/report/4?batchNo=${compre.batchNo}" target="_blank">体检总结</a></td>
                                    <td><fmt:formatDate value="${compre.batchDate}" pattern="yyyy-MM-dd" /></td>
                                </tr>
                            </c:forEach>
                        </c:if>
                    </table>
