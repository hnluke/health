...
<body>
<form id="submitForm" name="submitForm" action="manage/user/2" method="post">
                    ...
                    <div class="ui_content">
                        <div class="ui_tb" align="center">
                            <table align="center">
                                <tr>
                                    <td>姓名:</td>
                                    <td><input type="text" id="userName" name="userName" class="ui_input_txt02" autocomplete="off"/></td>
                                    <td>密码:</td>
                                    <td>
                                        <input type="text" id="userPwd" name="userPwd" class="ui_input_txt02" autocomplete="off"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>所属科室:</td>
                                    <td>
                                        <select name="offId" class ="ui_select01">
                                            <option value="0">--选择科室--</option>
                                            <c:if test="${!empty(offList)}">
                                                <c:forEach items="${offList}" var="off">
                                                    <option value="${off.offId}">${off.offName}</option>
                                                </c:forEach>
                                            </c:if>
                                    ...
                                    <td>权限:</td>
                                    <td>
                                        <select name="userPrioId" class ="ui_select01">
                                            <option value="0">--选择权限-</option>
                                            <c:if test="${!empty(prioList)}">
                                                <c:forEach items="${prioList}" var="prio">
