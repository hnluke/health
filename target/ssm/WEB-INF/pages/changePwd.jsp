...
<%--                <div id="box_border">--%>
<%--                    <div id="box_bottom">--%>
<%--                        <input type="button" value="未确认资产" class="ui_input_btn01" id="importBtn" style="text-align: left"--%>
<%--                               onclick="location.href='${pageContext.request.contextPath}/FinConfirmServlet?co=1&page=1'"/>--%>
            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <c:if test="${!empty(userList)}">
                        <c:forEach var="pur"  items="${userList}">

                            <tr>
                                <td><input type="checkbox" name="IDCheck" value="${pur.userId}" class="acb" /></td>
                                <td>${pur.userName}</td>
                                <td>${pur.office}</td>
                                <td>${pur.userPwd}</td>
                                <td>
