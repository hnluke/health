                    ...
                    <div class="ui_content">
                        <div class="ui_tb" style="text-align: center">
                            <table align="center">
                                <tr>
                                    <td>用户名:</td>
                                    <td><input type="text" id="u_name" name="u_name" class="ui_input_txt02" /></td>
                                </tr>
                                <tr>
                                    <td>密  码:</td>
                                    <td><input type="password" id="u_pwd" name="u_pwd" class="ui_input_txt02" /></td>
                                </tr>
                                <tr>
                                    <td>电  话:</td>
                                    <td><input type="text" id="u_tele" name="u_tele" class="ui_input_txt02" /></td>
                                </tr>
                                <tr>
                                    <td>权 限:</td>
                                    <td>
