...
<body>
<form id="submitForm" name="submitForm" action="office/addOffice" method="post">
        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0" >
                    <tr>
                        <th >
                            <input type="text" name="offName" placeholder="请输入新科室名称" style="width: 80%;height: 80%;">
                        </th>
                        <th><input type="submit"  value="确定" class="acb" style="width: 80%;height: 80%;" /></th>
