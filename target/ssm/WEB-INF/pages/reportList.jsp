...
<body>
<form id="submitForm" name="submitForm" action="check/report/2" method="post">
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    <div id="box_bottom">
                        ...
                        <input type="submit" value="体检报告列表" class="ui_input_btn01"/>
                        ...
                        <c:if test="${!empty(reportList)}">
                            <c:forEach var="report"  items="${reportList}">
                                <tr>
                                    ...
                                    <td>${report.person.cards.cardNo}</td>
                                    <td>${report.batchNo}</td>
                                    <td>${report.person.perName}</td>
                                    <td>${report.batchPay}</td>
                                    <td><a href="check/report/3?batchNo=${report.batchNo}" target="_blank">打印体检表</a></td>
                                    <td><a href="check/report/4?batchNo=${report.batchNo}" target="_blank">打印总结表</a></td>
                                </tr>
                            </c:forEach>
                        </c:if>
                    </table>
